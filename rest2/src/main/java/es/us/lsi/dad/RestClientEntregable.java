...
public class RestClientEntregable extends AbstractVerticle {
	...
	public void start(Promise<Void> startFuture) {
		 ...
		 */
		Promise<DHT11ListWrapper> resList = Promise.promise();
...
//		getRequest(8080, "http://localhost", "api/users", UserEntityListWrapper.class, resList);
		getRequest(8080, "http://localhost", "api/sensores", DHT11ListWrapper.class, resList);

		/*
		 * Post resource operation
		 */
		Promise<DHT11> resPost = Promise.promise();
...
//				UserEntity.class, resPost);
		postRequest(8080, "http://localhost", "api/sensores",
				new DHT11(777, 34, 90d, 30d),
				DHT11.class, resPost);

		/*
		 * Get single resource operation
		 */
		Promise<DHT11> res = Promise.promise();
		...
		getRequest(8080, "http://localhost", "api/sensores/777", DHT11.class, res);

		/*
		 * Put resource operation
		 */
		Promise<DHT11> resPut = Promise.promise();
		...
		putRequest(8080, "http://localhost", "api/sensores/777", new DHT11(777, 34, 99d, 99d), DHT11.class, resPut);

		/*
		 * Get resource operation using params
		 */
		Promise<DHT11ListWrapper> resWithParams = Promise.promise();
		...
		params.put("sensorid", "777");
		getRequestWithParams(8080, "http://localhost", "api/sensores/allParam", DHT11ListWrapper.class, resWithParams, params);
		

		/*
		 * Delete resource operation
		 */
		Promise<DHT11> resDelete = Promise.promise();
		...
		deleteRequest(8080, "http://localhost", "api/sensores/777", DHT11.class, resDelete);
